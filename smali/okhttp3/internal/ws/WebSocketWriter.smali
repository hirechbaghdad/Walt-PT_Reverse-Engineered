...
.method constructor <init>(ZLokio/BufferedSink;Ljava/util/Random;)V
    ...
    .line 66
    invoke-interface {p2}, Lokio/BufferedSink;->b()Lokio/Buffer;
...
.method private writeControlFrame(ILokio/ByteString;)V
    ...
    invoke-virtual {v1, p1}, Lokio/Buffer;->b(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, v1}, Lokio/Buffer;->b([B)Lokio/Buffer;
    ...
    invoke-virtual {p1}, Lokio/Buffer;->a()J
    ...
    invoke-virtual {p1, p2}, Lokio/Buffer;->a(Lokio/ByteString;)Lokio/Buffer;
    ...
    invoke-virtual {p1, p2}, Lokio/Buffer;->a(Lokio/Buffer$UnsafeCursor;)Lokio/Buffer$UnsafeCursor;

    .line 137
    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lokio/Buffer$UnsafeCursor;

    invoke-virtual {p1, v0, v1}, Lokio/Buffer$UnsafeCursor;->a(J)I
...
.method writeClose(ILokio/ByteString;)V
    ...
    .line 100
    invoke-virtual {v0, p2}, Lokio/Buffer;->a(Lokio/ByteString;)Lokio/Buffer;
...
.method writeMessageFrame(IJZZ)V
    ...
    invoke-virtual {p4, p1}, Lokio/Buffer;->b(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, p4}, Lokio/Buffer;->c(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, p2, p3}, Lokio/Buffer;->j(J)Lokio/Buffer;
    ...
    invoke-virtual {p1, p4}, Lokio/Buffer;->b([B)Lokio/Buffer;
    ...
    invoke-virtual {p1, p4, p5}, Lokio/Buffer$UnsafeCursor;->a(J)I
