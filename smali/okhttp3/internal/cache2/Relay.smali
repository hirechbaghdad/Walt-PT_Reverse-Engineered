...
.method public static read(Ljava/io/File;)Lokhttp3/internal/cache2/Relay;
    ...
    invoke-virtual {v0, v2, v3}, Lokio/Buffer;->d(J)Lokio/ByteString;
...
.method private writeHeader(Lokio/ByteString;JJ)V
    ...
    .line 167
    invoke-virtual {v3, p1}, Lokio/Buffer;->a(Lokio/ByteString;)Lokio/Buffer;

    .line 168
    invoke-virtual {v3, p2, p3}, Lokio/Buffer;->j(J)Lokio/Buffer;

    .line 169
    invoke-virtual {v3, p4, p5}, Lokio/Buffer;->j(J)Lokio/Buffer;
...
.method private writeMetadata(J)V
    ...
    invoke-virtual {v3, v0}, Lokio/Buffer;->a(Lokio/ByteString;)Lokio/Buffer;
