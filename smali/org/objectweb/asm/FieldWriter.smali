...
# instance fields
.field private final c:Lorg/objectweb/asm/ClassWriter;
...
.method constructor <init>(Lorg/objectweb/asm/ClassWriter;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lorg/objectweb/asm/ClassWriter;->r:Lorg/objectweb/asm/FieldWriter;

    if-nez v0, :cond_0

    iput-object p0, p1, Lorg/objectweb/asm/ClassWriter;->r:Lorg/objectweb/asm/FieldWriter;

    goto :goto_0

    :cond_0
    iget-object v0, p1, Lorg/objectweb/asm/ClassWriter;->s:Lorg/objectweb/asm/FieldWriter;

    iput-object p0, v0, Lorg/objectweb/asm/FieldWriter;->b:Lorg/objectweb/asm/FieldVisitor;

    :goto_0
    iput-object p0, p1, Lorg/objectweb/asm/ClassWriter;->s:Lorg/objectweb/asm/FieldWriter;

    iput-object p1, p0, Lorg/objectweb/asm/FieldWriter;->c:Lorg/objectweb/asm/ClassWriter;
    ...
    invoke-virtual {p1, p5}, Lorg/objectweb/asm/ClassWriter;->a(Ljava/lang/String;)I

    move-result p2

    iput p2, p0, Lorg/objectweb/asm/FieldWriter;->g:I
    ...
    iput p1, p0, Lorg/objectweb/asm/FieldWriter;->h:I
...
.method public a(ILorg/objectweb/asm/TypePath;Ljava/lang/String;Z)Lorg/objectweb/asm/AnnotationVisitor;
    ...
    iget-object p1, p0, Lorg/objectweb/asm/FieldWriter;->c:Lorg/objectweb/asm/ClassWriter;
    ...
    iget-object v1, p0, Lorg/objectweb/asm/FieldWriter;->c:Lorg/objectweb/asm/ClassWriter;
...
.method public a(Ljava/lang/String;Z)Lorg/objectweb/asm/AnnotationVisitor;
    ...
    iget-object v0, p0, Lorg/objectweb/asm/FieldWriter;->c:Lorg/objectweb/asm/ClassWriter;
    ...
    :cond_0
    iget-object p2, p0, Lorg/objectweb/asm/FieldWriter;->j:Lorg/objectweb/asm/AnnotationWriter;

    iput-object p2, p1, Lorg/objectweb/asm/AnnotationWriter;->c:Lorg/objectweb/asm/AnnotationWriter;

    iput-object p1, p0, Lorg/objectweb/asm/FieldWriter;->j:Lorg/objectweb/asm/AnnotationWriter;
...
.method public a(Lorg/objectweb/asm/Attribute;)V
    ...
    iget-object v0, p0, Lorg/objectweb/asm/FieldWriter;->m:Lorg/objectweb/asm/Attribute;

    iput-object v0, p1, Lorg/objectweb/asm/Attribute;->c:Lorg/objectweb/asm/Attribute;

    iput-object p1, p0, Lorg/objectweb/asm/FieldWriter;->m:Lorg/objectweb/asm/Attribute;
...
.method a(Lorg/objectweb/asm/ByteVector;)V
    ...
    iget v0, p0, Lorg/objectweb/asm/FieldWriter;->d:I
    ...
    iget v0, p0, Lorg/objectweb/asm/FieldWriter;->h:I
    ...
    :goto_0
    iget v3, p0, Lorg/objectweb/asm/FieldWriter;->d:I
    ...
    iget-object v3, p0, Lorg/objectweb/asm/FieldWriter;->c:Lorg/objectweb/asm/ClassWriter;

    iget v3, v3, Lorg/objectweb/asm/ClassWriter;->e:I
    ...
    :cond_3
    iget v3, p0, Lorg/objectweb/asm/FieldWriter;->g:I
    ...
    :cond_5
    iget-object v3, p0, Lorg/objectweb/asm/FieldWriter;->j:Lorg/objectweb/asm/AnnotationWriter;
    ...
    :cond_8
    iget-object v3, p0, Lorg/objectweb/asm/FieldWriter;->m:Lorg/objectweb/asm/Attribute;

    if-eqz v3, :cond_9

    iget-object v3, p0, Lorg/objectweb/asm/FieldWriter;->m:Lorg/objectweb/asm/Attribute;

    invoke-virtual {v3}, Lorg/objectweb/asm/Attribute;->c()I
    ...
    invoke-virtual {v0, v7}, Lorg/objectweb/asm/ClassWriter;->a(Ljava/lang/String;)I
    ...
    iget v7, p0, Lorg/objectweb/asm/FieldWriter;->h:I

    invoke-virtual {v0, v7}, Lorg/objectweb/asm/ByteVector;->b(I)Lorg/objectweb/asm/ByteVector;
    ...
    iget v0, v0, Lorg/objectweb/asm/ClassWriter;->e:I
    ...
    invoke-virtual {v0, v1}, Lorg/objectweb/asm/ClassWriter;->a(Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v2}, Lorg/objectweb/asm/ByteVector;->c(I)Lorg/objectweb/asm/ByteVector;
    ...
    iget-object v1, p0, Lorg/objectweb/asm/FieldWriter;->m:Lorg/objectweb/asm/Attribute;

    iget-object v2, p0, Lorg/objectweb/asm/FieldWriter;->c:Lorg/objectweb/asm/ClassWriter;
...
.method b()I
    ...
    invoke-virtual {v0, v2}, Lorg/objectweb/asm/ClassWriter;->a(Ljava/lang/String;)I
    ...
    :cond_3
    iget v2, p0, Lorg/objectweb/asm/FieldWriter;->g:I
    ...
    :cond_5
    iget-object v2, p0, Lorg/objectweb/asm/FieldWriter;->j:Lorg/objectweb/asm/AnnotationWriter;
    ...
    iget-object v2, p0, Lorg/objectweb/asm/FieldWriter;->m:Lorg/objectweb/asm/Attribute;
