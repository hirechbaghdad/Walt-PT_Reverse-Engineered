...
.field f:Lorg/objectweb/asm/Frame;

.field g:Lorg/objectweb/asm/Label;

.field h:Lorg/objectweb/asm/Edge;
...
.method private a(II)V
    ...
    iget-object v0, p0, Lorg/objectweb/asm/Label;->k:[I
    ...
    iput-object v0, p0, Lorg/objectweb/asm/Label;->k:[I

    :cond_0
    iget v0, p0, Lorg/objectweb/asm/Label;->j:I

    iget-object v2, p0, Lorg/objectweb/asm/Label;->k:[I
    ...
    iget-object v1, p0, Lorg/objectweb/asm/Label;->k:[I
    ...
    iget v1, p0, Lorg/objectweb/asm/Label;->j:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lorg/objectweb/asm/Label;->j:I

    aput p1, v0, v1

    iget-object p1, p0, Lorg/objectweb/asm/Label;->k:[I

    iget v0, p0, Lorg/objectweb/asm/Label;->j:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lorg/objectweb/asm/Label;->j:I
...
.method a()Lorg/objectweb/asm/Label;
    ...
    iget-object v0, p0, Lorg/objectweb/asm/Label;->f:Lorg/objectweb/asm/Frame;
...
.method a(JI)V
    ...
    iput-object p3, p0, Lorg/objectweb/asm/Label;->k:[I

    :cond_0
    iget-object p3, p0, Lorg/objectweb/asm/Label;->k:[I
...
.method a(Lorg/objectweb/asm/Label;JI)V
    ...
    iget-object v1, v0, Lorg/objectweb/asm/Label;->i:Lorg/objectweb/asm/Label;

    const/4 v2, 0x0

    iput-object v2, v0, Lorg/objectweb/asm/Label;->i:Lorg/objectweb/asm/Label;
    ...
    iget v3, v0, Lorg/objectweb/asm/Label;->d:I

    iput v3, v2, Lorg/objectweb/asm/Edge;->a:I

    iget-object v3, p1, Lorg/objectweb/asm/Label;->h:Lorg/objectweb/asm/Edge;
    ...
    iget-object v3, v0, Lorg/objectweb/asm/Label;->h:Lorg/objectweb/asm/Edge;

    iput-object v3, v2, Lorg/objectweb/asm/Edge;->c:Lorg/objectweb/asm/Edge;

    iput-object v2, v0, Lorg/objectweb/asm/Label;->h:Lorg/objectweb/asm/Edge;
    ...
    :cond_4
    :goto_2
    iget-object v2, v0, Lorg/objectweb/asm/Label;->h:Lorg/objectweb/asm/Edge;
    ...
    iget-object v3, v3, Lorg/objectweb/asm/Label;->i:Lorg/objectweb/asm/Label;

    if-nez v3, :cond_6

    iget-object v3, v2, Lorg/objectweb/asm/Edge;->b:Lorg/objectweb/asm/Label;

    iput-object v1, v3, Lorg/objectweb/asm/Label;->i:Lorg/objectweb/asm/Label;
...
.method a(Lorg/objectweb/asm/MethodWriter;Lorg/objectweb/asm/ByteVector;IZ)V
    ...
    :goto_0
    invoke-virtual {p2, p1}, Lorg/objectweb/asm/ByteVector;->c(I)Lorg/objectweb/asm/ByteVector;
...
.method a(Lorg/objectweb/asm/Label;)Z
    ...
    iget-object v3, p1, Lorg/objectweb/asm/Label;->k:[I
