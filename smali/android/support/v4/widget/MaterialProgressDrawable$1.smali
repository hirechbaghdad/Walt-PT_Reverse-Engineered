...
.method public applyTransformation(FLandroid/view/animation/Transformation;)V
    ...
    iget-boolean p2, p2, Landroid/support/v4/widget/MaterialProgressDrawable;->a:Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/MaterialProgressDrawable$1;->a:Landroid/support/v4/widget/MaterialProgressDrawable$Ring;

    invoke-static {p2, p1, v0}, Landroid/support/v4/widget/MaterialProgressDrawable;->a(Landroid/support/v4/widget/MaterialProgressDrawable;FLandroid/support/v4/widget/MaterialProgressDrawable$Ring;)V
    ...
    invoke-static {p2, v0}, Landroid/support/v4/widget/MaterialProgressDrawable;->a(Landroid/support/v4/widget/MaterialProgressDrawable;Landroid/support/v4/widget/MaterialProgressDrawable$Ring;)F
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->g()F
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->f()F
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->k()F

    move-result v2

    .line 377
    iget-object v3, p0, Landroid/support/v4/widget/MaterialProgressDrawable$1;->b:Landroid/support/v4/widget/MaterialProgressDrawable;
    ...
    invoke-static {v3, p1, v4}, Landroid/support/v4/widget/MaterialProgressDrawable;->b(Landroid/support/v4/widget/MaterialProgressDrawable;FLandroid/support/v4/widget/MaterialProgressDrawable$Ring;)V
    ...
    invoke-virtual {v5, v1}, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->b(F)V
    ...
    .line 404
    iget-object p2, p0, Landroid/support/v4/widget/MaterialProgressDrawable$1;->a:Landroid/support/v4/widget/MaterialProgressDrawable$Ring;

    invoke-virtual {p2, v0}, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->c(F)V
    ...
    invoke-virtual {p2, v2}, Landroid/support/v4/widget/MaterialProgressDrawable$Ring;->d(F)V
    ...
    invoke-virtual {p2, p1}, Landroid/support/v4/widget/MaterialProgressDrawable;->c(F)V
