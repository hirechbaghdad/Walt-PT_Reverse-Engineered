...
.method public constructor <init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->f:Landroid/graphics/Rect;

    .line 705
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a(Landroid/view/View;)V

    const/4 p2, 0x1

    .line 706
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a(Z)V

    const/4 p2, 0x0

    .line 707
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a(I)V
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;)Landroid/widget/ListAdapter;
    ...
    .line 697
    iget-object p0, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->e:Landroid/widget/ListAdapter;
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;Landroid/view/View;)Z
    ...
    .line 697
    invoke-direct {p0, p1}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->b(Landroid/view/View;)Z
...
.method private b(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->f:Landroid/graphics/Rect;
...
.method public a()V
    ...
    .line 775
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->d()Z

    move-result v0

    .line 777
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->f()V
    ...
    .line 781
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->e()Landroid/widget/ListView;
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    .line 725
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->e:Landroid/widget/ListAdapter;
...
.method public a(Ljava/lang/CharSequence;)V
    ...
    .line 734
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->d:Ljava/lang/CharSequence;
...
.method public b()Ljava/lang/CharSequence;
    ...
    .line 729
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->d:Ljava/lang/CharSequence;
...
.method f()V
    ...
    .line 750
    iget-object v3, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    .line 751
    iget-object v4, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->e:Landroid/widget/ListAdapter;
    ...
    .line 752
    invoke-static {v4, v5, v6}, Landroid/support/v7/widget/AppCompatSpinner;->a(Landroid/support/v7/widget/AppCompatSpinner;Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I

    move-result v4

    .line 754
    iget-object v5, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->g(I)V
    ...
    .line 771
    :goto_3
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->c(I)V
