...
.method constructor <init>(I)V
    ...
    .line 1926
    iput-boolean p1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->q:Z
...
.method a(Landroid/support/v7/view/menu/MenuPresenter$Callback;)Landroid/support/v7/view/menu/MenuView;
    ...
    .line 1991
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 1993
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/view/menu/ListMenuPresenter;
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/view/menu/ListMenuPresenter;
    ...
    .line 1997
    iget-object p1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 2000
    :cond_1
    iget-object p1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/view/menu/ListMenuPresenter;

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->g:Landroid/view/ViewGroup;
...
.method a(Landroid/content/Context;)V
    ...
    iput v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->b:I
    ...
    iput v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->f:I
...
.method a(Landroid/support/v7/view/menu/MenuBuilder;)V
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/view/menu/ListMenuPresenter;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/MenuBuilder;->b(Landroid/support/v7/view/menu/MenuPresenter;)V

    .line 1984
    :cond_1
    iput-object p1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/view/menu/MenuBuilder;
...
.method public a()Z
    ...
    .line 1930
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->h:Landroid/view/View;
    ...
    .line 1931
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->i:Landroid/view/View;
