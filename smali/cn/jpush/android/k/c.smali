...
# static fields
.field private static volatile a:Lcn/jpush/android/k/c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcn/jpush/android/k/c;->d:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcn/jpush/android/k/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lcn/jpush/android/k/c;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    return-void
.end method

.method public static a()Lcn/jpush/android/k/c;
    .locals 2

    sget-object v0, Lcn/jpush/android/k/c;->a:Lcn/jpush/android/k/c;

    if-nez v0, :cond_1

    sget-object v0, Lcn/jpush/android/k/c;->d:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jpush/android/k/c;->a:Lcn/jpush/android/k/c;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jpush/android/k/c;

    invoke-direct {v1}, Lcn/jpush/android/k/c;-><init>()V

    sput-object v1, Lcn/jpush/android/k/c;->a:Lcn/jpush/android/k/c;
...
.method private a(Lcn/jpush/android/api/CallBackParams;)Ljava/lang/String;
    ...
    invoke-static {v1, p1}, Lcn/jpush/android/helper/Logger;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method private a(Landroid/content/Context;IJ)V
    ...
    :goto_1
    invoke-virtual {p0, p3, p4}, Lcn/jpush/android/k/c;->a(J)Lcn/jpush/android/api/CallBackParams;
    ...
    :cond_1
    invoke-virtual {p0, p3, p4}, Lcn/jpush/android/k/c;->b(J)V

    const/4 p3, 0x0

    invoke-direct {p0, p1, v0, p2, p3}, Lcn/jpush/android/k/c;->a(Landroid/content/Context;Lcn/jpush/android/api/CallBackParams;IZ)V
...
.method private a(Landroid/content/Context;IJLandroid/content/Intent;)V
    ...
    invoke-virtual {v1, p3, p4}, Lcn/jpush/android/k/c;->b(J)V
    ...
    :goto_0
    invoke-static {p4, p5}, Lcn/jpush/android/helper/Logger;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p5, p4}, Lcn/jpush/android/helper/Logger;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method private a(Landroid/content/Context;Lcn/jpush/android/api/CallBackParams;IZ)V
    ...
    invoke-interface {p1, p3, p4, p2}, Lcn/jpush/android/api/TagAliasCallback;->a(ILjava/lang/String;Ljava/util/Set;)V
...
.method private c(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lcn/jpush/android/k/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lcn/jpush/android/k/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v3, v4, v5}, Lcn/jpush/android/api/CallBackParams;->a(J)Z
    ...
    invoke-static {v2, v3}, Lcn/jpush/android/helper/Logger;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v2, v3, v4}, Lcn/jpush/android/k/c;->a(Landroid/content/Context;IJ)V
...
.method public a(Landroid/content/Context;Landroid/content/Intent;)Lcn/jpush/android/api/JPushMessage;
    ...
    invoke-static {v3, v4}, Lcn/jpush/android/helper/Logger;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v0, v1}, Lcn/jpush/android/k/c;->a(J)Lcn/jpush/android/api/CallBackParams;
    ...
    invoke-virtual {v4, v0, v1}, Lcn/jpush/android/k/c;->b(J)V
    ...
    :goto_0
    invoke-static {p2, v4}, Lcn/jpush/android/helper/Logger;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, p2}, Lcn/jpush/android/helper/Logger;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p1}, Lcn/jpush/android/api/JPushMessage;->a(I)V

    iget p1, v3, Lcn/jpush/android/api/CallBackParams;->d:I

    invoke-virtual {p2, p1}, Lcn/jpush/android/api/JPushMessage;->b(I)V
    ...
    invoke-direct {p0, v3}, Lcn/jpush/android/k/c;->a(Lcn/jpush/android/api/CallBackParams;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p2, p1}, Lcn/jpush/android/api/JPushMessage;->b(Ljava/lang/String;)V

    invoke-virtual {p2, v2}, Lcn/jpush/android/api/JPushMessage;->a(Z)V

    invoke-virtual {p2, v1}, Lcn/jpush/android/api/JPushMessage;->b(Z)V
    ...
    invoke-virtual {p2, p1}, Lcn/jpush/android/api/JPushMessage;->a(Ljava/util/Set;)V
    ...
    invoke-virtual {p2, p1}, Lcn/jpush/android/api/JPushMessage;->a(Ljava/lang/String;)V
...
.method public declared-synchronized a(Landroid/content/Context;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcn/jpush/android/k/c;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v1, p0, Lcn/jpush/android/k/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    ...
    iput-object v1, p0, Lcn/jpush/android/k/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    ...
    iget-object p1, p0, Lcn/jpush/android/k/c;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(Landroid/content/Context;JILandroid/content/Intent;)V
    ...
    invoke-virtual {v2}, Lcn/jpush/android/k/c;->b()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {p0, p1, p4, p2, p3}, Lcn/jpush/android/k/c;->a(Landroid/content/Context;IJ)V
    ...
    invoke-direct/range {v0 .. v5}, Lcn/jpush/android/k/c;->a(Landroid/content/Context;IJLandroid/content/Intent;)V

    :goto_0
    invoke-virtual {p0, p1}, Lcn/jpush/android/k/c;->b(Landroid/content/Context;)V
...
.method public a(Landroid/content/Context;Ljava/lang/Long;Lcn/jpush/android/api/CallBackParams;)V
    ...
    invoke-direct {p0, p1}, Lcn/jpush/android/k/c;->c(Landroid/content/Context;)V

    iget-object p1, p0, Lcn/jpush/android/k/c;->c:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public declared-synchronized b(Landroid/content/Context;)V
    ...
    :try_start_1
    iget-object v0, p0, Lcn/jpush/android/k/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    ...
    iput-object p1, p0, Lcn/jpush/android/k/c;->b:Lcn/jpush/android/service/TagAliasReceiver;
    :try_end_1
    ...
    :goto_2
    invoke-static {p1, v0}, Lcn/jpush/android/helper/Logger;->a(Ljava/lang/String;Ljava/lang/String;)V
