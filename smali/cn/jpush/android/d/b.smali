...
.method public static a(Landroid/content/Intent;)Lcn/jpush/android/api/CustomMessage;
    ...
    :try_start_1
    iput-object v2, v1, Lcn/jpush/android/api/CustomMessage;->a:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcn/jpush/android/api/CustomMessage;->g:Ljava/lang/String;
    ...
    iput-object p0, v1, Lcn/jpush/android/api/CustomMessage;->f:Ljava/lang/String;
    ...
    iput-object p0, v1, Lcn/jpush/android/api/CustomMessage;->c:Ljava/lang/String;
    ...
    iput-object p0, v1, Lcn/jpush/android/api/CustomMessage;->d:Ljava/lang/String;
    ...
    iput-object p0, v1, Lcn/jpush/android/api/CustomMessage;->e:Ljava/lang/String;
    ...
    iput-object p0, v1, Lcn/jpush/android/api/CustomMessage;->b:Ljava/lang/String;
    :try_end_1
...
.method private static a(Landroid/content/Context;IJJ)V
    ...
    invoke-static {v0, p1, p2, p3}, Lcn/jpush/android/j/b;->a(IBJ)[B
    ...
    invoke-static/range {v1 .. v7}, Lcn/jpush/android/helper/JCoreHelper;->a(Landroid/content/Context;Ljava/lang/String;IIJ[B)V
...
.method public static a(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;JB)V
    ...
    :cond_2
    invoke-static {p0, p1}, Lcn/jpush/android/h/b;->c(Landroid/content/Context;Lcn/jpush/android/d/d;)Z
    ...
    :cond_3
    iput-byte p7, p1, Lcn/jpush/android/d/d;->W:B
...
.method public static a(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/h/b;->c(Landroid/content/Context;)Z
    ...
    :cond_6
    invoke-static {p0, p1}, Lcn/jpush/android/h/b;->a(Landroid/content/Context;Lcn/jpush/android/d/d;)V

    :cond_7
    return-void
.end method

.method public static a(Landroid/content/Context;Lcn/jpush/android/j/c;)V
    .locals 14

    invoke-virtual {p1}, Lcn/jpush/android/j/c;->b()I

    move-result v1

    invoke-virtual {p1}, Lcn/jpush/android/j/c;->c()J

    move-result-wide v2

    invoke-virtual {p1}, Lcn/jpush/android/j/c;->f()J
    ...
    invoke-virtual {p1}, Lcn/jpush/android/j/c;->d()Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcn/jpush/android/helper/Logger;->h(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v8, p1, v0, v1}, Lcn/jpush/android/k/a;->a(Landroid/content/Context;Ljava/lang/String;IJ)J
    ...
    invoke-static {p1, v0, p0}, Lcn/jpush/android/helper/Logger;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static b(Landroid/content/Context;Lcn/jpush/android/d/d;)V
    ...
    invoke-virtual {v0, p0, v1}, Lcn/jpush/android/service/JPushMessageReceiver;->a(Landroid/content/Context;Lcn/jpush/android/api/CustomMessage;)V
    ...
    :goto_0
    iget-byte v0, p1, Lcn/jpush/android/d/d;->W:B
    ...
    invoke-static {v0, v2, p1, v1, p0}, Lcn/jpush/android/helper/c;->a(Ljava/lang/String;Ljava/lang/String;BILandroid/content/Context;)V
