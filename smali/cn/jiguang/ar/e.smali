.class public final Lcn/jiguang/ar/e;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lcn/jiguang/ar/f;-><init>()V

    sput-object v0, Lcn/jiguang/ar/e;->a:Ljava/util/Comparator;
...
.method public static a(Landroid/content/Context;Ljava/util/LinkedHashSet;J)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v6}, Lcn/jiguang/ar/d;->a(Ljava/lang/String;)Lcn/jiguang/ar/d;

    move-result-object v6

    if-nez v6, :cond_3

    new-instance v6, Lcn/jiguang/ar/d;

    invoke-direct {v6, v4}, Lcn/jiguang/ar/d;-><init>(Lcn/jiguang/ar/h;)V

    :cond_3
    if-eqz v3, :cond_4

    iput v2, v6, Lcn/jiguang/ar/d;->e:I
    ...
    iput-wide p2, v6, Lcn/jiguang/ar/d;->c:J

    new-array v4, v2, [Lcn/jiguang/g/a;

    invoke-virtual {v6}, Lcn/jiguang/ar/d;->a()Ljava/lang/String;
    ...
    :cond_6
    sget-object p0, Lcn/jiguang/ar/e;->a:Ljava/util/Comparator;

    invoke-static {v1, p0}, Lcn/jiguang/ar/e;->a(Ljava/util/Collection;Ljava/util/Comparator;)Ljava/util/LinkedList;
    ...
    check-cast p3, Lcn/jiguang/ar/d;

    iget-object p3, p3, Lcn/jiguang/ar/d;->a:Lcn/jiguang/ar/h;
...
.method public static a(Landroid/content/Context;Lcn/jiguang/ar/h;IJ)V
    .locals 2

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lcn/jiguang/ar/h;->toString()Ljava/lang/String;
    ...
    invoke-static {v1}, Lcn/jiguang/ar/d;->a(Ljava/lang/String;)Lcn/jiguang/ar/d;
    ...
    invoke-direct {v1, p1}, Lcn/jiguang/ar/d;-><init>(Lcn/jiguang/ar/h;)V

    :cond_0
    iput-wide p3, v1, Lcn/jiguang/ar/d;->d:J

    iput p2, v1, Lcn/jiguang/ar/d;->b:I
    ...
    invoke-virtual {v1}, Lcn/jiguang/ar/d;->a()Ljava/lang/String;
