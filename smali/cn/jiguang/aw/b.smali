.class public final Lcn/jiguang/aw/b;
.super Lcn/jiguang/aw/a;
...
.method public constructor <init>(II)V
    ...
    invoke-direct {p0}, Lcn/jiguang/aw/a;-><init>()V

    iput p1, p0, Lcn/jiguang/aw/b;->g:I
    ...
    iput-object p1, p0, Lcn/jiguang/aw/b;->h:Ljava/nio/ByteBuffer;

    iput p2, p0, Lcn/jiguang/aw/b;->f:I
...
.method private b([B)Z
    ...
    :try_start_0
    invoke-virtual {p0}, Lcn/jiguang/aw/b;->a()Z
    ...
    :cond_1
    iget-object v1, p0, Lcn/jiguang/aw/b;->b:Ljava/nio/channels/SocketChannel;
    ...
    invoke-static {v1, p1}, Lcn/jiguang/an/d;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcn/jiguang/aw/b;->close()V
...
.method public final declared-synchronized a(Ljava/lang/String;I)I
    ...
    :try_start_0
    invoke-super {p0, p1, p2}, Lcn/jiguang/aw/a;->a(Ljava/lang/String;I)I
    :try_end_0
    ...
    iput-object v1, p0, Lcn/jiguang/aw/b;->b:Ljava/nio/channels/SocketChannel;

    invoke-static {}, Ljava/nio/channels/Selector;->open()Ljava/nio/channels/Selector;

    move-result-object v1

    iput-object v1, p0, Lcn/jiguang/aw/b;->d:Ljava/nio/channels/Selector;
    ...
    iget-object p1, p0, Lcn/jiguang/aw/b;->b:Ljava/nio/channels/SocketChannel;
    ...
    iget-boolean v1, p0, Lcn/jiguang/aw/b;->e:Z
    ...
    :cond_2
    :try_start_3
    iget-boolean p1, p0, Lcn/jiguang/aw/b;->e:Z
    ...
    iget-object p2, p0, Lcn/jiguang/aw/b;->d:Ljava/nio/channels/Selector;
    ...
    invoke-static {p2, v1}, Lcn/jiguang/an/d;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a([B)I
    ...
    iget v2, p0, Lcn/jiguang/aw/b;->g:I
    ...
    iget v1, p0, Lcn/jiguang/aw/b;->g:I
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcn/jiguang/aw/b;->b([B)Z
...
.method public final a(I)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0}, Lcn/jiguang/aw/b;->b()I

    move-result v2

    if-lez v2, :cond_0

    invoke-virtual {p0, v2}, Lcn/jiguang/aw/b;->b(I)Ljava/nio/ByteBuffer;
    ...
    iget v5, p0, Lcn/jiguang/aw/b;->c:I

    if-ge v5, v3, :cond_9

    if-lez p1, :cond_2

    iget-object v5, p0, Lcn/jiguang/aw/b;->d:Ljava/nio/channels/Selector;
    ...
    invoke-static {v6, v5}, Lcn/jiguang/an/d;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v1, v2}, Lcn/jiguang/at/e;-><init>(ILjava/lang/String;)V
    ...
    iget-object v4, p0, Lcn/jiguang/aw/b;->h:Ljava/nio/ByteBuffer;
    ...
    iget-object v7, p0, Lcn/jiguang/aw/b;->h:Ljava/nio/ByteBuffer;
    ...
    iget-object v8, p0, Lcn/jiguang/aw/b;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v6, p0, Lcn/jiguang/aw/b;->a:Ljava/nio/ByteBuffer;

    iget-object v8, p0, Lcn/jiguang/aw/b;->h:Ljava/nio/ByteBuffer;

    invoke-virtual {v6, v8}, Ljava/nio/ByteBuffer;->put(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;

    iget v6, p0, Lcn/jiguang/aw/b;->c:I

    add-int/2addr v6, v7

    iput v6, p0, Lcn/jiguang/aw/b;->c:I

    iget-object v6, p0, Lcn/jiguang/aw/b;->h:Ljava/nio/ByteBuffer;

    invoke-virtual {v6}, Ljava/nio/ByteBuffer;->compact()Ljava/nio/ByteBuffer;

    iget v6, p0, Lcn/jiguang/aw/b;->c:I

    iget v8, p0, Lcn/jiguang/aw/b;->f:I
    ...
    iget v9, p0, Lcn/jiguang/aw/b;->c:I
    ...
    invoke-static {v6, v4}, Lcn/jiguang/an/d;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcn/jiguang/aw/b;->a:Ljava/nio/ByteBuffer;
    ...
    invoke-direct {p1, v6, v2}, Lcn/jiguang/at/e;-><init>(ILjava/lang/String;)V
    ...
    iget v1, p0, Lcn/jiguang/aw/b;->c:I
    ...
    invoke-virtual {p0, v3}, Lcn/jiguang/aw/b;->b(I)Ljava/nio/ByteBuffer;
    ...
    invoke-direct {p1, v0, v1}, Lcn/jiguang/at/e;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p1, v2, v3}, Lcn/jiguang/at/e;-><init>(ILjava/lang/String;)V
    ...
    instance-of v1, p1, Lcn/jiguang/at/e;

    if-eqz v1, :cond_d

    check-cast p1, Lcn/jiguang/at/e;
    ...
    invoke-direct {v1, v0, p1}, Lcn/jiguang/at/e;-><init>(ILjava/lang/String;)V
...
.method public final close()V
    ...
    invoke-super {p0}, Lcn/jiguang/aw/a;->close()V

    iget-object v0, p0, Lcn/jiguang/aw/b;->d:Ljava/nio/channels/Selector;
    ...
    :catch_0
    :cond_0
    iget-object v0, p0, Lcn/jiguang/aw/b;->b:Ljava/nio/channels/SocketChannel;

    invoke-static {v0}, Lcn/jiguang/f/k;->a(Ljava/io/Closeable;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lcn/jiguang/aw/b;->b:Ljava/nio/channels/SocketChannel;
