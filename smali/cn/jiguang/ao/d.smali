...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v2, v3, v1, v3}, Lcn/jiguang/f/f;-><init>(ZZLjava/lang/String;I)V
...
.method public static b(Landroid/content/Context;)V
    ...
    new-instance v1, Lcn/jiguang/ao/f;

    invoke-direct {v1, p0}, Lcn/jiguang/ao/f;-><init>(Landroid/content/Context;)V
...
.method private static b(Landroid/content/Context;Ljava/io/File;)V
    ...
    sget-object v6, Lcn/jiguang/ao/d;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p0, v2, v1, v0, v3}, Lcn/jiguang/ao/k;->a(Landroid/content/Context;Ljava/util/Set;Lorg/json/JSONObject;Ljava/io/File;Lcn/jiguang/api/ReportCallBack;)I
...
.method private static c(Landroid/content/Context;Ljava/io/File;)V
    ...
    new-array v3, v1, [Ljava/io/FileFilter;

    sget-object v4, Lcn/jiguang/f/f;->a:Lcn/jiguang/f/f;

    aput-object v4, v3, v0

    invoke-static {v2, v3}, Lcn/jiguang/f/e;->a(Ljava/io/File;[Ljava/io/FileFilter;)[Ljava/io/File;
    ...
    invoke-static {v0, p0}, Lcn/jiguang/ao/c;->a(Ljava/io/File;Lorg/json/JSONObject;)Lcn/jiguang/ao/c;
    ...
    :cond_4
    invoke-virtual {p1, v0, v3}, Lcn/jiguang/ao/c;->a(Lcn/jiguang/ao/c;Ljava/io/File;)Z
    ...
    invoke-virtual {p1, p0, v3}, Lcn/jiguang/ao/c;->a(Lcn/jiguang/ao/c;Ljava/io/File;)Z
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static d(Ljava/io/File;)V
    ...
    sget-object v3, Lcn/jiguang/f/f;->a:Lcn/jiguang/f/f;

    const/4 v4, 0x0

    aput-object v3, v2, v4

    invoke-static {v0, v2}, Lcn/jiguang/f/e;->a(Ljava/io/File;[Ljava/io/FileFilter;)[Ljava/io/File;
    ...
    sget-object v8, Lcn/jiguang/ao/d;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v1}, Lcn/jiguang/f/e;->a([Ljava/io/File;)Ljava/io/File;

    move-result-object v1

    invoke-static {v1, v0}, Lcn/jiguang/ao/c;->a(Ljava/io/File;Ljava/util/Set;)Lcn/jiguang/ao/c;

    move-result-object v1

    if-eqz v1, :cond_4

    iget-object v4, v1, Lcn/jiguang/ao/c;->b:Lorg/json/JSONObject;
    ...
    invoke-static {v2, v0}, Lcn/jiguang/ao/c;->a(Ljava/io/File;Ljava/util/Set;)Lcn/jiguang/ao/c;

    move-result-object v2

    if-eqz v2, :cond_5

    iget-object v4, v2, Lcn/jiguang/ao/c;->b:Lorg/json/JSONObject;
    ...
    check-cast v5, Lcn/jiguang/ao/c;
    ...
    :cond_6
    invoke-virtual {v5, v2, p0}, Lcn/jiguang/ao/c;->a(Lcn/jiguang/ao/c;Ljava/io/File;)Z
    ...
    invoke-virtual {v1, v2, p0}, Lcn/jiguang/ao/c;->a(Lcn/jiguang/ao/c;Ljava/io/File;)Z
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
