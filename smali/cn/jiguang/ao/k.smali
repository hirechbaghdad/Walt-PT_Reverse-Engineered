...
.method public static a(Landroid/content/Context;Ljava/util/Set;Lorg/json/JSONObject;Ljava/io/File;Lcn/jiguang/api/ReportCallBack;)I
    ...
    invoke-static {p3}, Lcn/jiguang/ao/d;->a(Ljava/io/File;)V

    const/4 v0, -0x2

    if-eqz v8, :cond_1

    invoke-interface {v8, v0}, Lcn/jiguang/api/ReportCallBack;->a(I)V
    ...
    invoke-static {v1, v10, v3}, Lcn/jiguang/ao/k;->a(Ljava/lang/String;ZI)Landroid/util/Pair;
    ...
    const-string v7, "will upload length="
    ...
    invoke-static {v1, v5}, Lcn/jiguang/an/d;->b(Ljava/lang/String;Ljava/lang/String;)V

    array-length v1, v3

    sget-boolean v5, Lcn/jiguang/ao/k;->b:Z
    ...
    invoke-static {p3}, Lcn/jiguang/f/e;->a(Ljava/io/File;)V
    :try_end_2
    ...
    invoke-interface {v8, v1}, Lcn/jiguang/api/ReportCallBack;->a(I)V
    ...
    invoke-interface {v8, v11}, Lcn/jiguang/api/ReportCallBack;->a(I)V
    ...
    invoke-interface {v8, v9}, Lcn/jiguang/api/ReportCallBack;->a(I)V
...
.method private static a(Landroid/content/Context;[BILjava/util/Set;)I
    ...
    invoke-virtual {v1, p0}, Lcn/jiguang/ao/a;->b(Landroid/content/Context;)Lcn/jiguang/ao/a;

    move-result-object v1

    invoke-virtual {v1, p3}, Lcn/jiguang/ao/a;->b(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {v2}, Lcn/jiguang/g/a;->a(Z)Lcn/jiguang/g/a;
    ...
    invoke-static {v7}, Lcn/jiguang/f/i;->f(Ljava/lang/String;)Z

    move-result v8

    if-eqz v8, :cond_4

    sget-boolean v8, Lcn/jiguang/ao/k;->c:Z
    ...
    :cond_4
    invoke-static {v7}, Lcn/jiguang/f/i;->g(Ljava/lang/String;)Z
    ...
    :goto_6
    invoke-static {v1, v4}, Lcn/jiguang/an/d;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "won\'t use http at device since 28"

    goto :goto_6

    :cond_a
    sget-object v4, Lcn/jiguang/ao/k;->e:Ljava/lang/String;
    ...
    invoke-static/range {v6 .. v11}, Lcn/jiguang/ao/b;->a(Landroid/content/Context;Ljava/lang/String;[BIII)Lcn/jiguang/ao/n;

    move-result-object v1

    invoke-virtual {v1}, Lcn/jiguang/ao/n;->a()I
    ...
    invoke-virtual {v1}, Lcn/jiguang/ao/n;->b()Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcn/jiguang/ao/d;->a(Landroid/content/Context;[Ljava/lang/String;)V
...
.method private static a(Ljava/lang/String;ZI)Landroid/util/Pair;
    ...
    :try_start_2
    invoke-static {p0, v0, v1, v2}, Lcn/jiguang/bb/d;->a([BLjava/lang/String;Ljava/lang/String;Z)[B
...
.method public static a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {}, Lcn/jiguang/bb/a;->a()Ljava/lang/String;

    move-result-object v0

    invoke-static {p0, v0}, Lcn/jiguang/bb/d;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;)Lorg/json/JSONObject;
    ...
    invoke-static {v2}, Lcn/jiguang/f/i;->a(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v1}, Lcn/jiguang/an/d;->h(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v1}, Lcn/jiguang/internal/ActionManager;->a(Lorg/json/JSONObject;)Z
    ...
    invoke-static {v2, v3}, Lcn/jiguang/an/d;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, v2}, Lcn/jiguang/an/d;->g(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Landroid/content/Context;ILorg/json/JSONObject;[BILjava/io/File;Ljava/util/Set;Lcn/jiguang/api/ReportCallBack;)V
    ...
    :try_start_1
    sget-boolean p1, Lcn/jiguang/internal/JConstants;->f:Z
    ...
    const-string p4, "http upload success, json="
    ...
    :cond_1
    :try_start_2
    sget-boolean p0, Lcn/jiguang/internal/JConstants;->f:Z

    if-eqz p0, :cond_2

    sget-boolean p0, Lcn/jiguang/internal/JConstants;->g:Z
    ...
    const-string p4, "tcp upload success, json="
    ...
    invoke-static {p0, p2}, Lcn/jiguang/an/d;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p7, p0}, Lcn/jiguang/api/ReportCallBack;->a(I)V
    ...
    invoke-interface {p7, p1}, Lcn/jiguang/api/ReportCallBack;->a(I)V
...
.method public static a(Landroid/content/Context;Ljava/lang/Object;)V
    ...
    new-instance v1, Lcn/jiguang/ao/l;

    invoke-direct {v1, p1, p0}, Lcn/jiguang/ao/l;-><init>(Ljava/lang/Object;Landroid/content/Context;)V
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p1, p2, p0}, Lcn/jiguang/an/d;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_1
...
.method static synthetic a(Landroid/content/Context;Lorg/json/JSONArray;Ljava/util/Set;)V
    ...
    invoke-virtual {v0, p0}, Lcn/jiguang/ao/a;->a(Landroid/content/Context;)Lcn/jiguang/ao/a;

    move-result-object v0

    invoke-virtual {v0, p2}, Lcn/jiguang/ao/a;->a(Ljava/util/Set;)Ljava/lang/String;
    ...
    invoke-static {p1, v4, v5}, Lcn/jiguang/ao/k;->a(Lorg/json/JSONArray;II)Ljava/util/ArrayList;
    ...
    :try_start_1
    invoke-static {v4, v1}, Lcn/jiguang/ao/k;->a(Lorg/json/JSONArray;Lorg/json/JSONObject;)Lorg/json/JSONObject;

    move-result-object v4

    invoke-static {p0, v0, v4, v3}, Lcn/jiguang/ao/d;->a(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;Z)Ljava/io/File;
    ...
    new-instance v7, Lcn/jiguang/ao/m;

    invoke-direct {v7, p0, p2, v4, v5}, Lcn/jiguang/ao/m;-><init>(Landroid/content/Context;Ljava/util/Set;Lorg/json/JSONObject;Ljava/io/File;)V

    invoke-static {v6, v7}, Lcn/jiguang/ba/a;->a(Ljava/lang/String;Ljava/lang/Runnable;)V
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-static {v6, v4, v2, v7, v5}, Lcn/jiguang/an/a;->a(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/String;)V
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_1
...
.method public static a(Landroid/content/Context;Lorg/json/JSONObject;Lcn/jiguang/api/ReportCallBack;)V
    ...
    invoke-interface {p2, p1}, Lcn/jiguang/api/ReportCallBack;->a(I)V
    ...
    invoke-static {p1, v0}, Lcn/jiguang/ao/k;->a(Lorg/json/JSONArray;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    invoke-static {p0, v0, p1, v1, p2}, Lcn/jiguang/ao/k;->a(Landroid/content/Context;Ljava/util/Set;Lorg/json/JSONObject;Ljava/io/File;Lcn/jiguang/api/ReportCallBack;)I
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
